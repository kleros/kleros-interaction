...
contract('ArbitrableTokenList', function(accounts) {
  ...
  describe('queryItems', function() {
    ...
    it.skip('should succesfully retrieve mySubmissions', async function() {
      const cursor = 0
      const count = 1
    ...
    it.skip('should succesfully retrieve pending', async function() {
      const cursor = 0
      const count = 1
    ...
    it.skip('should revert when not cursor < itemsList.length', async function() {
      const cursor = 1
      const count = 1
      ...
      for (const rechallengePossible of [true, false])
        describe(
          ...
          () => {
            ...
            it.skip('should be constructed correctly', async () => {
              assert.equal(
            ...
            describe('msg.value restrictions', function() {
              describe('Should revert when msg.value < stake+arbitratorCost', function() {
                it.skip('requestRegistration', async () => {
                  await expectThrow(
                ...
                it.skip('challengeRegistration', async () => {
                  await expectThrow(
                    arbitrableTokenList.challengeRegistration(
                      ARBITRARY_STRING,
                      {
                        from: arbitrator,
                        value: stake + arbitrationCost - 1
                ...
                it.skip('challengeClearing', async () => {
                  await expectThrow(
                    arbitrableTokenList.challengeRegistration(
                      ARBITRARY_STRING,
                      {
            ...
            describe('When !(item.status==ItemStatus.ClearingRequested || item.status==ItemStatus.PreventiveClearingRequested))', function() {
              ...
              it.skip('challengeRegistration', async function() {
                await expectThrow(
                  arbitrableTokenList.challengeRegistration(ARBITRARY_STRING, {
                    from: arbitrator,
                    value: stake + arbitrationCost
              ...
              it.skip('challengeClearing', async function() {
                await expectThrow(
                  arbitrableTokenList.challengeClearing(ARBITRARY_STRING, {
                    from: arbitrator,
                    value: stake + arbitrationCost
            ...
            if (!rechallengePossible) {
              describe('When item in absent state', function() {
                ...
                it.skip('calling requestRegistration should move item into the submitted state', async () => {
                  await arbitrableTokenList.requestRegistration(
                    ARBITRARY_STRING,
                    metaEvidence,
                    REQUEST.arbitrationFeesWaitingTime,
                ...
                if (!appendOnly)
                  ...
                  it.skip('calling requestClearing should revert', async () => {
                    await expectThrow(
                      arbitrableTokenList.requestClearing(
                        ARBITRARY_STRING,
                        metaEvidence,
                ...
                it.skip('calling challangeBlacklisting should revert', async () => {
                  await expectThrow(
                    arbitrableTokenList.challengeRegistration(
                      ARBITRARY_STRING,
                      {
                ...
                it.skip('calling challangeClearing should revert', async () => {
                  await expectThrow(
                    arbitrableTokenList.challengeClearing(ARBITRARY_STRING, {
                      from: arbitrator,
                      value: stake + arbitrationCost
                ...
                it.skip('calling executeRequest should revert', async () => {
                  await expectThrow(
              ...
              if (!appendOnly)
                describe.skip('When item in cleared state', function() {
                  beforeEach('prepare pre-conditions', async function() {
                    ...
                    // await arbitrableTokenList.executeRequest(
                    //   ARBITRARY_STRING,
                    //   {
                    //     from: arbitrator
                    //   }
                  ...
                  it(
                    ...
                    async () => {
                      // assert.equal(
                      //   await arbitrableTokenList.isPermitted(
                      //     ARBITRARY_STRING
                      //   ),
                      //   blacklist
                      // )
                  ...
                  it.skip('calling requestRegistration should move item into the resubmitted state', async () => {
                    await arbitrableTokenList.requestRegistration(
                      ARBITRARY_STRING,
                      metaEvidence,
                      REQUEST.arbitrationFeesWaitingTime,
              ...
              if (!appendOnly)
                describe.skip('When item in resubmitted state', function() {
                  ...
                  it.skip('calling challengeBlacklisting should create a dispute', async function() {
                    ...
                    assert.equal(
                      web3.toUtf8(
                        await arbitrableTokenList.disputeIDToItem(disputeID)
                      ),
                      ARBITRARY_STRING
                    )
                  })
              ...
              if (!appendOnly)
                describe.skip('When item in clearing requested state', function() {
                  ...
                  it.skip('calling challangeClearing should create a dispute', async function() {
                    ...
                    await arbitrableTokenList.challengeClearing(
                      ARBITRARY_STRING,
                      {
                        from: partyA,
                        value: stake + arbitrationCost
